...
/* найти все комбинации цилиндров, которые достигают все позиции, если это возможно, или сообщить о невозможности этого */

find_all_trays(RezList,RezNum):-not(check_all_trays),findall(X,ext(X,_),UncheckedList),!,tray(NZ),seq([],0,UncheckedList,RezList,RezNum,NZ).
