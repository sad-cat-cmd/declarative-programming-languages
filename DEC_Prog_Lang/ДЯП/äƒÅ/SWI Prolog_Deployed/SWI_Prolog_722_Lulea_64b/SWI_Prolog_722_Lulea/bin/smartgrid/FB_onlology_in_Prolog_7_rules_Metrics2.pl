...
hasName(i80, "F1_iPIOC_1_Ev").
hasName(i81, "F1_iPTRC_1_Ev").
hasName(i86, iPTRC_F1_Tr_general).
hasName(i87, iPTRC_F1_Tr_general).
hasName(i84, "F1_iPTRC_1_Ev").
hasName(i85, "F1_iXCBR_1_Ev").
hasName(i90, 'Tr_general_iPTRC_F1_iPIOC_F2').
hasName(i91, 'Tr_general_iPTRC_F1_iPIOC_F2').
hasName(i88, "F1_iPTRC_1_Ev").
hasName(i89, "F2_iPIOC_1_Ev").
hasName(i94, 'Tr_general_iPTRC_F1_iPIOC_F3').
hasName(i95, 'Tr_general_iPTRC_F1_iPIOC_F3').
hasName(i92, "F1_iPTRC_1_Ev").
hasName(i93, "F3_iPIOC_1_Ev").
hasName(i98, 'Tr_general_iPTRC_F1_iPIOC_F4').
hasName(i99, 'Tr_general_iPTRC_F1_iPIOC_F4').
hasName(i96, "F1_iPTRC_1_Ev").
hasName(i97, "F4_iPIOC_1_Ev").
hasName(i102, 'Tr_general_iPTRC_F1_iPIOC_T').
hasName(i103, 'Tr_general_iPTRC_F1_iPIOC_T').
hasName(i100, "F1_iPTRC_1_Ev").
hasName(i101, "Tr_iPIOC_1_Ev").
hasName(i106, iTCTR_F1_AmpSv_instMag).
hasName(i107, iTCTR_F1_AmpSv_instMag).
hasName(i104, "F1_iTCTR_1_Ev").
hasName(i105, "F1_iPIOC_1_Ev").
hasName(i110, iPIOC_F2_Op_general).
hasName(i111, iPIOC_F2_Op_general).
hasName(i108, "F2_iPIOC_1_Ev").
hasName(i109, "F2_iPTRC_1_Ev").
hasName(i114, 'Tr_general_iPTRC_F2_iPIOC_F1').
hasName(i115, 'Tr_general_iPTRC_F2_iPIOC_F1').
hasName(i112, "F2_iPTRC_1_Ev").
hasName(i113, "F1_iPIOC_1_Ev").
hasName(i118, iPTRC_F2_Tr_general).
hasName(i119, iPTRC_F2_Tr_general).
hasName(i116, "F2_iPTRC_1_Ev").
hasName(i117, "F2_iXCBR_1_Ev").
hasName(i122, 'Tr_general_iPTRC_F2_iPIOC_F3').
hasName(i123, 'Tr_general_iPTRC_F2_iPIOC_F3').
hasName(i120, "F2_iPTRC_1_Ev").
hasName(i121, "F3_iPIOC_1_Ev").
hasName(i126, 'Tr_general_iPTRC_F2_iPIOC_F4').
hasName(i127, 'Tr_general_iPTRC_F2_iPIOC_F4').
hasName(i124, "F2_iPTRC_1_Ev").
hasName(i125, "F4_iPIOC_1_Ev").
hasName(i130, 'Tr_general_iPTRC_F2_iPIOC_T').
hasName(i131, 'Tr_general_iPTRC_F2_iPIOC_T').
hasName(i128, "F2_iPTRC_1_Ev").
hasName(i129, "Tr_iPIOC_1_Ev").
hasName(i134, iTCTR_F2_AmpSv_instMag).
hasName(i135, iTCTR_F2_AmpSv_instMag).
hasName(i132, "F2_iTCTR_1_Ev").
hasName(i133, "F2_iPIOC_1_Ev").
hasName(i138, iPIOC_F3_Op_general).
hasName(i139, iPIOC_F3_Op_general).
hasName(i136, "F3_iPIOC_1_Ev").
hasName(i137, "F3_iPTRC_1_Ev").
hasName(i142, 'Tr_general_iPTRC_F3_iPIOC_F1').
hasName(i143, 'Tr_general_iPTRC_F3_iPIOC_F1').
hasName(i140, "F3_iPTRC_1_Ev").
hasName(i141, "F1_iPIOC_1_Ev").
hasName(i146, 'Tr_general_iPTRC_F3_iPIOC_F2').
hasName(i147, 'Tr_general_iPTRC_F3_iPIOC_F2').
hasName(i144, "F3_iPTRC_1_Ev").
hasName(i145, "F2_iPIOC_1_Ev").
hasName(i150, iPTRC_F3_Tr_general).
hasName(i151, iPTRC_F3_Tr_general).
hasName(i148, "F3_iPTRC_1_Ev").
hasName(i149, "F3_iXCBR_1_Ev").
hasName(i154, 'Tr_general_iPTRC_F3_iPIOC_F4').
hasName(i155, 'Tr_general_iPTRC_F3_iPIOC_F4').
hasName(i152, "F3_iPTRC_1_Ev").
hasName(i153, "F4_iPIOC_1_Ev").
hasName(i158, 'Tr_general_iPTRC_F3_iPIOC_T').
hasName(i159, 'Tr_general_iPTRC_F3_iPIOC_T').
hasName(i156, "F3_iPTRC_1_Ev").
hasName(i157, "Tr_iPIOC_1_Ev").
hasName(i162, iTCTR_F3_AmpSv_instMag).
hasName(i163, iTCTR_F3_AmpSv_instMag).
hasName(i160, "F3_iTCTR_1_Ev").
hasName(i161, "F3_iPIOC_1_Ev").
hasName(i166, iPIOC_F4_Op_general).
hasName(i167, iPIOC_F4_Op_general).
hasName(i164, "F4_iPIOC_1_Ev").
hasName(i165, "F4_iPTRC_1_Ev").
hasName(i170, 'Tr_general_iPTRC_F4_iPIOC_F1').
hasName(i171, 'Tr_general_iPTRC_F4_iPIOC_F1').
hasName(i168, "F4_iPTRC_1_Ev").
hasName(i169, "F1_iPIOC_1_Ev").
hasName(i174, 'Tr_general_iPTRC_F4_iPIOC_F2').
hasName(i175, 'Tr_general_iPTRC_F4_iPIOC_F2').
hasName(i172, "F4_iPTRC_1_Ev").
hasName(i173, "F2_iPIOC_1_Ev").
hasName(i178, 'Tr_general_iPTRC_F4_iPIOC_F3').
hasName(i179, 'Tr_general_iPTRC_F4_iPIOC_F3').
hasName(i176, "F4_iPTRC_1_Ev").
hasName(i177, "F3_iPIOC_1_Ev").
hasName(i182, iPTRC_F4_Tr_general).
hasName(i183, iPTRC_F4_Tr_general).
hasName(i180, "F4_iPTRC_1_Ev").
hasName(i181, "F4_iXCBR_1_Ev").
hasName(i186, 'Tr_general_iPTRC_F4_iPIOC_T').
hasName(i187, 'Tr_general_iPTRC_F4_iPIOC_T').
hasName(i184, "F4_iPTRC_1_Ev").
hasName(i185, "Tr_iPIOC_1_Ev").
hasName(i190, iTCTR_F4_AmpSv_instMag).
hasName(i191, iTCTR_F4_AmpSv_instMag).
hasName(i188, "F4_iTCTR_1_Ev").
hasName(i189, "F4_iPIOC_1_Ev").
hasName(i194, iPIOC_T_Op_general).
hasName(i195, iPIOC_T_Op_general).
hasName(i192, "Tr_iPIOC_1_Ev").
hasName(i193, "Tr_iPTRC_1_Ev").
hasName(i198, 'Tr_general_iPTRC_T_iXCBR_F1').
hasName(i199, 'Tr_general_iPTRC_T_iXCBR_F1').
hasName(i196, "Tr_iPTRC_1_Ev").
hasName(i197, "F1_iXCBR_1_Ev").
hasName(i202, 'Tr_general_iPTRC_T_iXCBR_F2').
hasName(i203, 'Tr_general_iPTRC_T_iXCBR_F2').
hasName(i200, "Tr_iPTRC_1_Ev").
hasName(i201, "F2_iXCBR_1_Ev").
hasName(i206, 'Tr_general_iPTRC_T_iXCBR_F3').
hasName(i207, 'Tr_general_iPTRC_T_iXCBR_F3').
hasName(i204, "Tr_iPTRC_1_Ev").
hasName(i205, "F3_iXCBR_1_Ev").
hasName(i210, 'Tr_general_iPTRC_T_iXCBR_F4').
hasName(i211, 'Tr_general_iPTRC_T_iXCBR_F4').
hasName(i208, "Tr_iPTRC_1_Ev").
hasName(i209, "F4_iXCBR_1_Ev").
hasName(i214, iPTRC_T_Tr_general).
hasName(i215, iPTRC_T_Tr_general).
hasName(i212, "Tr_iPTRC_1_Ev").
hasName(i213, "Tr_iXCBR_1_Ev").
hasName(i218, iTCTR_T_AmpSv_instMag).
hasName(i219, iTCTR_T_AmpSv_instMag).
hasName(i216, "Tr_iTCTR_1_Ev").
hasName(i217, "Tr_iPIOC_1_Ev").

/* Print information about all FBs including their name, type, inputs, outputs, etc) */

write_all_FB_info:- 
writeln("---------------------------------------------------"), 
writeln("Info about Function Blocks"), 
writeln("----------------------------------------------------"),
dynamic('FunctionBlock'/1), 'FunctionBlock'(Fb), hasName(Fb, NameFb), has_FB_type(Fb, TypeFb), writeln(" ***"),
write("FB name: "), string_concat(NameFb, "/", N1), string_concat(N1, Fb, N2), writeln(N2), write("FB type: "), writeln(TypeFb), 
write_FBRes(Fb),
write("EventInputs of FB: "), write_EIs(Fb), writeln("###"),
write("EventOutputs of FB: "), write_EOs(Fb), writeln("###"),
write("InputVariables of FB: "), write_IVs(Fb), writeln("###"),
write("OutputVariables of FB: "), write_OVs(Fb), writeln("###"),
fail.
write_all_FB_info.

/* Print information about mapped Resource */

write_FBRes(Fb):-  is_mapped_to(Fb, Res), hasName(Res, NameRes), write("Resource: "), writeln(NameRes),!.
write_FBRes(_):-  writeln("Resource missing !!!").

/* Print all EventInputs of the given FB */

write_EIs(Fb):- dynamic('EventInput'/1), 'EventInput'(Ei), is_part_of_FB(Ei, Fb), 
hasName(Ei, NameEi), string_concat(NameEi, "/", N1), string_concat(N1, Ei, N2), string_concat(N2, "; ", N3), write(N3), fail.
write_EIs(Fb).

/* Print all EventOutputs of the given FB */

write_EOs(Fb):- dynamic('EventOutput'/1), 'EventOutput'(Eo), is_part_of_FB(Eo, Fb), 
hasName(Eo, NameEo), string_concat(NameEo, "/", N1), string_concat(N1, Eo, N2), string_concat(N2, "; ", N3), write(N3), fail.
write_EOs(Fb).

/* Print all InputVariables of the given FB */

write_IVs(Fb):- dynamic('InputVariable'/1), 'InputVariable'(Iv), is_part_of_FB(Iv, Fb), 
hasName(Iv, NameIv), string_concat(NameIv, "/", N1), string_concat(N1, Iv, N2), string_concat(N2, "; ", N3), write(N3), fail.
write_IVs(Fb).

/* Print all OutputVariables of the given FB */

write_OVs(Fb):- dynamic('OutputVariable'/1), 'OutputVariable'(Ov), is_part_of_FB(Ov, Fb), 
hasName(Ov, NameOv), string_concat(NameOv, "/", N1), string_concat(N1, Ov, N2), string_concat(N2, "; ", N3), write(N3), fail.
write_OVs(Fb).
