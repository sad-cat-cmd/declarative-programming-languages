...
write_fb_status(Fb):- write("NOT IN CYCLE").
...
edge(Ei,Eo):- 
'FunctionBlock'(Fb), 'EventInput'(Ei), 'EventOutput'(Eo), is_part_of_FB(Ei,Fb), is_part_of_FB(Eo,Fb), !.

edge(Curr , Next):- e_connect_to(Curr, Next).
