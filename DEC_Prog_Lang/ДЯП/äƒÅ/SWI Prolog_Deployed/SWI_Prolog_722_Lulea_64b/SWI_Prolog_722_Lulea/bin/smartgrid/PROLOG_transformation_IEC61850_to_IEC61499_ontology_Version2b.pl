...
open('FB_onlology_in_Prolog.pl', write, S),  /* write the generated FB ontology to the file */
set_output(S),
...
close(S),
open('Subsidiary_info.pl', write, S2), 		/* write the generated subsidiary info to the file */
set_output(S2),
