...
index((load_rdf_ntriples), 2, rdf_ntriples_old, rdf_ntriples).
index((rdf_ntriple_part), 4, rdf_ntriples_old, rdf_ntriples).
...
index((rsa_private_decrypt), 3, ssl, ssl).
index((rsa_private_encrypt), 3, ssl, ssl).
index((rsa_public_decrypt), 3, ssl, ssl).
index((rsa_public_encrypt), 3, ssl, ssl).
index((rsa_private_decrypt), 4, ssl, ssl).
index((rsa_private_encrypt), 4, ssl, ssl).
index((rsa_public_decrypt), 4, ssl, ssl).
index((rsa_public_encrypt), 4, ssl, ssl).
...
index((term_to_json), 3, term_to_json, term_to_json).
index((term_to_json), 2, term_to_json, term_to_json).
...
index((udp_host_to_address), 2, udp_broadcast, udp_broadcast).
