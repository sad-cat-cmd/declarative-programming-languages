...
class(emacs_tag_item, text_item, '', 'emacs_tags.pl').
...
class(change_fragment, fragment, 'Indicate suggested change', 'isocomp.pl').
...
class(grapher, picture, 'Picture showing graph', 'pce_grapher.pl').
...
class(xref_frame, persistent_frame, 'GUI for the Prolog cross-referencer', 'pce_xref.pl').
...
class(pui_manual, persistent_frame, 'Frame for Prolog help', 'swi_help.pl').
class(prolog_ide, application, 'Prolog IDE application', 'swi_ide.pl').
